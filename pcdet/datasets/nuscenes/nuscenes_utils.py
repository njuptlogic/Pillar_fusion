    ...
    for index, sample in enumerate(nusc.sample):
        ...
        if with_cam:
            ...
            for cam in camera_types:
                ...
                cam_path, _, camera_intrinsics = nusc.get_sample_data(cam_token, box_vis_level=BoxVisibility.ANY)
                ...
                calib = calib[:3]
                info['calib'] = calib.tolist()
                sd_record_2 = nusc.get('sample_data', cam_token)
                info['width'] = sd_record_2['width']
                info['height'] = sd_record_2['height']
                ...
                info['radar_pc'] = all_points.points.tolist()
